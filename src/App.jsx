...
function App() {
  ...
  const nextStep = () => {
    ...
    if (currentStep === 1 && !formData.whatsapp.trim()) {
      alert('Por favor, digite seu WhatsApp!');
      return;
    }
    if (currentStep === 2 && !formData.renda) {
      alert('Por favor, selecione sua faixa de renda!');
      return;
    }
    if (currentStep === 3 && !selectedUnit) {
      alert('Por favor, escolha uma casa!');
      return;
    }
              ...
              {selectedUnit && selectedPlan && (
                <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-r from-green-100 to-orange-100 border-2 border-green-300 rounded-xl p-4 text-center shadow-lg">
                    ...
                    <div className="space-y-2">
                      <p className="text-gray-800 font-medium">Nome: <span className="text-green-600">{formData.nome}</span></p>
